    ...
    <section id="SeccionInscripcion" className="bg-soft-custom py-12">
      <div className="max-w-2xl mx-auto p-6 rounded-lg shadow-lg bg-card-custom">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="name" className="block text-soft-dark mb-2">
              Nombre del evento
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="email" className="block text-soft-dark mb-2">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="mb-4">
            <label htmlFor="event" className="block text-soft-dark mb-2">
              Selecciona un evento deportivo
            </label>
            <select
              id="event"
              value={event}
          ...
          {event && (
            <>
              <div className="mb-4">
                <label htmlFor="date" className="block text-soft-dark mb-2">
                  Selecciona la fecha
                </label>
                <select
                  id="date"
              ...
              <div className="mb-4">
                <label htmlFor="time" className="block text-soft-dark mb-2">
                  Selecciona la hora
                </label>
                <select
                  id="time"
          ...
          <button
            type="submit"
            className="w-full bg-gradient-custom text-white font-semibold py-3 rounded hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-teal-400"
          >
            Inscribirse
          </button>
        </form>
