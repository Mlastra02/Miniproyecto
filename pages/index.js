    ...
    <div className="bg-soft-custom text-soft-dark min-h-screen">
      ...
      <nav className="bg-gradient-custom text-soft-light text-center py-2 rounded-b-full shadow-lg mt-0 mb-0">
        <ul className="nav-list flex justify-center space-x-4 list-none p-0 m-0">
          <li>
            <a
              href="#seccion1"
              className="text-soft-light font-bold hover:text-teal-200"
            >
              Inicio
            </a>
          </li>
      ...
      <main>
        <Seccion1
          ...
          description="Registra tu evento deportivo y participa en las competencias registrada en la base de datos de AMJ Innovation"
        />
        <Galeria />
        <SeccionInscripcion />
      </main>
      ...
      <footer className="bg-gradient-custom text-center py-4">
        <p className="text-teal-100">
          &copy; 2024 Ejemplo de Sitio Web. Todos los derechos reservados.
        </p>
      </footer>
    </div>
  );
